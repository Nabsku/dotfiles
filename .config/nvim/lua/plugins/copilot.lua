  ...
  specs = {
    ...
    },
    {
      ...
      opts = function(_, opts)
        ...
        opts.keymap["<Tab>"] = {
          copilot_action "accept", -- Copilot inline completions first
          function() -- sidekick NSE next edit suggestion
            return require("sidekick").nes_jump_or_apply()
          end,
          "select_next", -- blink.cmp completion menu navigation
          "snippet_forward", -- snippet jump
          "fallback",
        }
